...
namespace COM.TIGER.PGIS.Model
{
    ...
    /// 
    ///</summary>
    [Common.Attr.RemoteController(ControllerName = "PassCar", ModelName = "PassCars")]
    [System.Runtime.Serialization.DataContract(Name = "PassCar", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MPassCar :MBase
    {
        private int _ID;
        ///<summary>
        /// 
