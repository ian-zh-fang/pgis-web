...
namespace COM.TIGER.PGIS.Model
{
    ...
    /// 
    ///</summary>
    [Common.Attr.RemoteController(ControllerName = "Street", ModelName = "Streets")]
    [System.Runtime.Serialization.DataContract(Name = "Street", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MStreet :MBase
    {
        private int _ID;
        ///<summary>
        /// 
