...
namespace COM.TIGER.PGIS.Model
{
    ...
    /// 
    ///</summary>
    [Common.Attr.RemoteController(ControllerName = "Employee", ModelName = "Employees")]
    [System.Runtime.Serialization.DataContract(Name = "Employee", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MEmployee :MBase
    {
        private int _ID;
        ///<summary>
        /// 
    ...
    [Common.Attr.RemoteController(ControllerName = "Employee", ModelName = "Employees")]
    [System.Runtime.Serialization.DataContract(Name = "MCompanyEmployee", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MCompanyEmployee : MEmployee
    {
        [System.Runtime.Serialization.DataMember(Name = "Company")]
        public Model.MCompany Company { get; set; }
