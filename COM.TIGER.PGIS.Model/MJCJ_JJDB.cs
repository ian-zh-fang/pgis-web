...
namespace COM.TIGER.PGIS.Model
{
    ...
    /// 
    ///</summary>
    [Common.Attr.RemoteController(ControllerName = "JCJ_JJDB", ModelName = "JCJ_JJDBs")]
    [System.Runtime.Serialization.DataContract(Name = "JCJ_JJDB", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MJCJ_JJDB :MBase
    {
        private int _ID;
        ///<summary>
        /// 
