...
namespace COM.TIGER.PGIS.Model
{
    ...
    /// 
    ///</summary>
    [Common.Attr.RemoteController(ControllerName = "StreetNum", ModelName = "StreetNums")]
    [System.Runtime.Serialization.DataContract(Name = "StreetNum", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MStreetNum :MBase
    {
        private int _ID;
        ///<summary>
        /// 
