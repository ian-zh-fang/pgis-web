...
namespace COM.TIGER.PGIS.Model
{
    ...
    /// 
    ///</summary>
    [Common.Attr.RemoteController(ControllerName = "YJBJ", ModelName = "YJBJs")]
    [System.Runtime.Serialization.DataContract(Name = "YJBJ", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MYJBJ :MBase
    {
        private int _ID;
        ///<summary>
        /// 
