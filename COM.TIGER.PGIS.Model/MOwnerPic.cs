...
{
    [Common.Attr.RemoteController(ControllerName = "OwnerPic", ModelName = "OwnerPic")]
    [System.Runtime.Serialization.DataContract(Name = "ownerPic", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MOwnerPic : MBase
    {
        private int _MOP_ID;
        ///<summary>
        /// 
