...
namespace COM.TIGER.PGIS.Model
{
    ...
    /// 
    ///</summary>
    [Common.Attr.RemoteController(ControllerName = "Hotel", ModelName = "Hotels")]
    [System.Runtime.Serialization.DataContract(Name = "Hotel", Namespace = "http://www.tiger.com/pgis/model/")]
    public class MHotel :MBase
    {
        private int _ID;
        ///<summary>
        /// 
